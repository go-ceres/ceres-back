...
// genTablename 生成表名获取方法
func genTablename(table *parse.Table, prefix string) (string, error) {
	tplText, err := utils.LoadTpl(category, tablenameTemplate, model.Tablename)
	if err != nil {
		return "", err
	}
